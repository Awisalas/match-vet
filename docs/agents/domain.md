...
If the glossary doesn't contain the concept, reconsider whether you're inventing language the project doesn't use. If it is a real gap, note it for `$domain-modeling`.
